...
namespace RealERPWEB.F_81_Hrm.F_84_Lea
{
    public partial class MovementRegister : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    ((Label)this.Master.FindControl("lblTitle")).Text = "MOVEMENT REGISTER";

                this.Master.Page.Title = "MOVEMENT REGISTER";



               GetRemaningTime();
               GetAllTimeOff();
                gvLvReq.RowDataBound += new GridViewRowEventHandler(gvLvReq_RowDataBound);

                this.idsectionremaningtime.Visible = false;
        ...
        private void GetAllTimeOff()
        {
            ...
            string vtoffstatus;
            if (this.ddlTimeoffType.SelectedValue == "0")
            {
                vtoffstatus = "0";
            ...
            DataSet ds1 = HRData.GetTransInfo(comcod, "dbo_hrm.SP_REPORT_HR_EMPSTATUS", "GETTIMEOFLEAVEHISTORYALL", empid, vtoffstatus, "", "", "", "", "");
        ...
        private void GetRemaningTime()
        {
            ...
            DataSet ds1 = HRData.GetTransInfo(comcod, "dbo_hrm.SP_REPORT_HR_EMPSTATUS", "GETTIMEOFLEAVEHISTORY", empid, frmdate, tdate, vtoffstatus, "", "", "", "");
            ...
            if (this.ddlTimeoffType.SelectedValue == "0")
            {
                useTime = ds1.Tables[2].Rows.Count == 0 ? DateTime.Parse("06:00") : DateTime.Parse(ds1.Tables[2].Rows[0]["USETIME"].ToString());
            }

            else {

               useTime = ds1.Tables[2].Rows.Count == 0 ? DateTime.Parse("09:00") : DateTime.Parse(ds1.Tables[2].Rows[0]["USETIME1"].ToString());
            ...
            if (ds1.Tables[0].Rows.Count != 0)
            {
                ...
                DateTime maxTime = DateTime.Parse("09:00");
        ...
        public void GetUseTimeCalCulate()
        {
            ...
            DateTime Offic_end = Convert.ToDateTime(cdate + " 06:00 PM");
            ...
            TimeSpan maxTime1 = TimeSpan.Parse("09:00");
            TimeSpan enjtime = TimeSpan.Parse("09:00");
            ...
            else if ((enjtime > remTimeConvt))
            {
                ...
                this.txtUseTime.Text = enjtime.ToString();
            }
            else
            {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            string vtoffstatus = this.ddlTimeoffType.SelectedValue.ToString();

            string reqfor = "Movement Register";
            ...
            {
                bool result = HRData.UpdateTransInfo(comcod, "dbo_hrm.SP_REPORT_HR_INTERFACE", "INSERT_REQ_ATTN_CAHNGE", dayID, empid, reqdate, reqtype, reqtimeOUT, reqtimeIN, txtReson, usetime, usrid, postDat, "", vtoffstatus);
                ...
                else
                {
                    ...
                    string Messaged = "Successfully applied the application of Movement Register.";
        ...
        protected void ddlTimeoffType_SelectedIndexChanged(object sender, EventArgs e)
        {

            if (this.ddlTimeoffType.SelectedValue == "0")
            {
                this.idsectionremaningtime.Visible = true;
            }
            else
            {
                this.idsectionremaningtime.Visible = false;
        ...
        protected void txtaplydate_TextChanged(object sender, EventArgs e)
        {
            GetRemaningTime();
        }
        ...
        protected void chKDNR_CheckedChanged(Object sender, EventArgs args)
        {
            if (chKDNR.Checked == true)
            {
                ...
                DateTime Offic_end = Convert.ToDateTime(cdate + " 06:00 PM");
                DateTime Offic_ST = Convert.ToDateTime(cdate + " 09:00 AM");
                this.txtToTime.Text= Convert.ToDateTime(Offic_ST).ToString("HH:mm");
                this.txtToTime.Text = Convert.ToDateTime(Offic_end).ToString("HH:mm");
                this.iblinout.Visible = false;
                this.GetUseTimeCalCulate();

            }
            else 
            {
                this.iblinout.Visible = true;
        ...
        protected void gvLvReq_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            //if (this.ddlTimeoffType.SelectedValue == "0")
            //{
            // gvLvReq.Columns[7].Visible = true;
               
            //}
            //else
            //{
            //  gvLvReq.Columns[7].Visible = false;
        ...
        protected void lnkTimeEdit_Click(object sender, EventArgs e)
        {
            ...
            string reason = ((Label)this.gvLvReq.Rows[index].FindControl("lblReason")).Text.ToString().Trim();
        ...
        protected void lnkTimeUpdate_Click_Click(object sender, EventArgs e)
        {
            ...
            TimeSpan time3 = timeDiff;
            TimeSpan maxTime1 = TimeSpan.Parse("09:00");
            TimeSpan enjtime = TimeSpan.Parse("9:00");
            ...
            else
            {
                ...
                bool result = HRData.UpdateTransInfo(comcod, "dbo_hrm.SP_REPORT_HR_EMPSTATUS", "UPDATETIMEOFF", id, outtime, type, timeDiff.ToString(), intime, reason, "2", "");
