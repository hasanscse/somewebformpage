<%@ Page Title="" Language="C#" MasterPageFile="~/ASITNEW.Master" AutoEventWireup="true" CodeBehind="MovementRegister.aspx.cs" Inherits="RealERPWEB.F_81_Hrm.F_84_Lea.MovementRegister" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="card-fluid container-data  mt-4">
            ...
            <div class="row" id="Lvform" runat="server">
                <div class="col-12 col-lg-12 col-xl-3">
                    <section class="card card-fluid" style="min-height: 650px">
                        <header class="card-header"> <b>Application for Movemenet Register</b></header>
                        <div class="card-body" id="ApplicFrm" runat="server">
                            ...
                            <div class="form-group" id="empMgt" runat="server" visible="false">
                               ...
                               <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="ddlTimeoffType" OnSelectedIndexChanged="ddlTimeoffType_SelectedIndexChanged" AutoPostBack="true" class="form-control" runat="server">
                                  <%--  <asp:ListItem   Text="Time off" Value="0"></asp:ListItem>
                                    <asp:ListItem Value="1" Text="Visit for Official Work"></asp:ListItem>--%>
                                    <asp:ListItem Value="2" Text="Client Visit"></asp:ListItem>
                                    <asp:ListItem Value="3" Text="Project Visit"></asp:ListItem>
                                    <asp:ListItem Value="4" Text="Official Work Visit"></asp:ListItem>
                                    <asp:ListItem Value="5" Text="Land Visit"></asp:ListItem>
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtaplydate" runat="server" OnTextChanged="txtaplydate_TextChanged"   AutoPostBack="true" class="form-control"></asp:TextBox>
                                <cc1:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd-MMM-yyyy"
                                    TargetControlID="txtaplydate"></cc1:CalendarExtender>
                            </div>
                            <div class="form-group" runat="server" id="idsectionremaningtime">
                                <label for="ddlLvType">
                                    Remaning Time   
                                </label>
                            ...
                            <div id="iblinout" runat="server">
                            <div class="row">
                                <div class="col-md-6 pl-0">
                                    <div class="form-group">
                                        <label for="sel1" id="frmdate" runat="server">Out Time<span class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6 pl-0">
                                    <div class="form-group">
                                        <label for="sel1" id="Label1" runat="server">In Time<span class="text-danger">*</span></label>
                             ...
                             <div class="form-group" >
                                ...
                                <asp:CheckBox ID="chKDNR" runat="server" OnCheckedChanged="chKDNR_CheckedChanged"  AutoPostBack="true" class="form-control" Text="DNR" Font-Bold="true"  ></asp:CheckBox>
...
<%--                        <header class="card-header">Time of Leave History</header>--%>
                        ...
                        <div class="card-body">
                            <strong>Current month movement history</strong>
                                    ...
                                    <asp:TemplateField HeaderText="Current Status">
                                        <ItemTemplate>
                                            <asp:Label ID="txtgvCust" runat="server" BackColor="Transparent"
                                                Text='<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "reqstatus")) %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" />
                   ...
                   <%--                 <asp:TemplateField HeaderText="">
                            ...
                            <hr />
                            <strong>All Movement Register History</strong>
                            <asp:GridView ID="gvLvReqAll" runat="server" AutoGenerateColumns="False" CssClass="table-striped table-hover table-bordered" ShowFooter="True" >
                                <RowStyle />
                                <Columns>
                                    <asp:TemplateField HeaderText="Sl">
                                        <ItemTemplate>
                               ...
                               <h6 class="modal-title font-weight-bold text-white p-0 m-0" id="">Edit Time Off</h6>
                                ...
                                <div class="card-body bg-light">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="txtreason" id="lblReason" class="from-control" >Reason<Span class="txt-danger">*</Span></label>
                                        <asp:TextBox ID="txtreason"  Width="430"  runat="server" TextMode="MultiLine" Rows="2" class="from-control" ></asp:TextBox>
