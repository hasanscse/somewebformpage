<%@ Page Title="" Language="C#" MasterPageFile="~/ASITNEW.Master" AutoEventWireup="true" CodeBehind="HREmpEntryn.aspx.cs" Inherits="RealERPWEB.F_81_Hrm.F_82_App.HREmpEntryn" %>
                ...
                <asp:View ID="Services" runat="server">
                    ...
                    <fieldset class="scheduler-border fieldset_A">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-1 d-flex align-items-center">
                                <asp:Label ID="Label2" runat="server" class="col-form-label">Company</asp:Label>
                            </div>

                            <div class="col-md-2 d-flex align-items-center gap-2">
                                <asp:TextBox ID="txtSrcCompanyAgg" runat="server" CssClass="form-control small-textbox"></asp:TextBox>
                                <asp:LinkButton ID="ibtnFindCompanyAgg" runat="server" CssClass="btn btn-primary btn-sm" OnClick="ibtnFindCompanyAgg_Click"><i class="fas fa-search"></i></asp:LinkButton>
                            </div>

                            <div class="col-md-3">
                                <asp:DropDownList ID="ddlCompanyAgg" OnSelectedIndexChanged="ddlCompanyAgg_SelectedIndexChanged" runat="server" CssClass="form-control inputTxt chzn-select" AutoPostBack="true" TabIndex="0">
                                </asp:DropDownList>
                            ...
                            <div class="colMid">
                                <asp:LinkButton ID="lnkbtnSerOk" runat="server" CssClass="btn btn-primary okBtn btn" OnClick="lnkbtnSerOk_Click">Ok</asp:LinkButton>
                            </div>
                            <div class="col-md-3">
                                ...
                                <asp:CheckBox ID="ChkImportSupervisation" runat="server" AutoPostBack="True"
                                    ...
                                    TabIndex="13" CssClass="btn btn-primary checkBox" Text="<span class='fa fa-download'></span>Supervisation" Visible="false" />
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-1 d-flex align-items-center">
                                <asp:Label ID="lbldeptnameagg" runat="server" class="col-form-label">Department</asp:Label>
                            </div>

                            <div class="col-md-2 d-flex align-items-center gap-2">
                                <asp:TextBox ID="txtsrchdeptagg" runat="server" CssClass="form-control small-textbox"></asp:TextBox>

                                <asp:LinkButton ID="lbtndeptagg" runat="server" CssClass="btn btn-primary btn-sm" OnClick="lbtndeptagg_Click">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-1 d-flex align-items-center">
                                ...
                                <asp:Label ID="lblsection" runat="server" class="col-form-label">Section</asp:Label>
                            </div>

                            <div class="col-md-2 d-flex align-items-center gap-2">
                                <asp:TextBox ID="txtSrcPro" runat="server" CssClass="form-control small-textbox"></asp:TextBox>
                                <asp:LinkButton ID="ibtnFindProject" runat="server" CssClass="btn btn-primary btn-sm" OnClick="ibtnFindProject_Click"><i class="fas fa-search"></i></asp:LinkButton>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-1 d-flex align-items-center">
                                <asp:Label ID="lblEmp" runat="server" class="col-form-label">Emp.  Name</asp:Label>

                            </div>

                            <div class="col-md-2 d-flex align-items-center gap-2">
                                <asp:TextBox ID="txtSrcEmp" runat="server" CssClass="form-control small-textbox"></asp:TextBox>
                                <asp:LinkButton ID="ibtnFindEmp" runat="server" CssClass="btn btn-primary btn-sm" OnClick="ibtnFindEmp_Click"><i class="fas fa-search"></i></asp:LinkButton>
                            </div>
                        ...
                        <fieldset class="scheduler-border fieldset_A">
                            ...
                            <div class="row d-flex align-items-center flex-wrap gap-2">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <asp:Label ID="lblvaljoindate" runat="server" ReadOnly="true" CssClass="inputTxt inputName inpPixedWidth"></asp:Label>
                                </div>

                                <!-- PF Starting Date -->
                                <div class="d-flex align-items-center">
                                    <asp:Label ID="lblpfstdate" runat="server" CssClass="lblTxt lblName">PF Starting Date</asp:Label>
                                ...
                                <!-- End Date -->
                                <div class="d-flex align-items-center">
                                    <asp:Label ID="lblpfenddate" runat="server" CssClass="lblTxt lblName">End Date</asp:Label>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <asp:Label ID="lblDesgination" runat="server" ReadOnly="true" CssClass="inputTxt inputName inpPixedWidth"></asp:Label>
                                </div>

                                <!-- Designation Dropdown -->
                                <div class="d-flex align-items-center">
                                    <asp:DropDownList ID="ddlDesignation" AutoPostBack="true" OnSelectedIndexChanged="ddlDesignation_SelectedIndexChanged" runat="server" CssClass="chzn-select form-control inputTxt"></asp:DropDownList>
                                </div>

                                <!-- Sales Role -->
                                <div class="d-flex align-items-center">
                                    <asp:Label ID="Label8" runat="server" CssClass="lblTxt lblName" Style="width: 100px;">Sales Role</asp:Label>
                                    <asp:ListBox ID="ListSalesRole" runat="server" CssClass="form-control form-control-sm" SelectionMode="Multiple" Style="min-height: 200px !important;"></asp:ListBox>
                                </div>
                            ...
                            <div class="row d-flex align-items-center flex-wrap gap-2">
                                <!-- Office InTime -->
                              <div class="d-flex align-items-center col-md-2 pading5px">
                                <asp:Label ID="lbltOfftime" runat="server" CssClass="lblTxt lblName" Style="margin-right: 5px;">Office InTime</asp:Label>
                                <asp:Label ID="lbloffintime" runat="server" ReadOnly="true" Width="98" CssClass="inputTxt inputName inpPixedWidth"></asp:Label>
                                  </div>

                                <div class="d-flex align-items-center col-md-1 pading5px">
                                    <asp:DropDownList ID="ddlOffintime" AutoPostBack="true" OnSelectedIndexChanged="ddlOffintime_SelectedIndexChanged" runat="server" CssClass="form-control inputTxt" TabIndex="16"></asp:DropDownList>
                                </div>

                                <!-- Office OutTime -->
                                <div class="d-flex align-items-center col-md-2 pading5px">
                                    <asp:Label ID="lbltOfftime0" runat="server" CssClass="lblTxt lblName"  Style="margin-right: 5px;" >Office OutTime</asp:Label>
                                    <asp:Label ID="lbloffouttime" runat="server" ReadOnly="true" Width="98" CssClass="inputTxt inputName inpPixedWidth"></asp:Label>
                                </div>
                                <div class="d-flex align-items-center col-md-1 pading5px">
                                    <asp:DropDownList ID="ddlOffouttime" AutoPostBack="true" OnSelectedIndexChanged="ddlOffouttime_SelectedIndexChanged" runat="server" CssClass="form-control inputTxt" TabIndex="17"></asp:DropDownList>
                                </div>

                                <!-- Lunch InTime -->
                                <div class="d-flex align-items-center col-md-2 pading5px">
                                    <asp:Label ID="lbltLantime" runat="server" CssClass="lblTxt lblName"  Style="margin-right: 5px;" >Lunch InTime</asp:Label>
                                    <asp:Label ID="lbllanintime" runat="server" Width="98" ReadOnly="true" CssClass="inputTxt inputName inpPixedWidth"></asp:Label>
                                </div>
                                <div class="d-flex align-items-center col-md-1 pading5px">
                                    <asp:DropDownList ID="ddlLanintime" AutoPostBack="true" OnSelectedIndexChanged="ddlLanintime_SelectedIndexChanged" runat="server" CssClass="form-control inputTxt" TabIndex="17"></asp:DropDownList>
                                </div>

                                <!-- Lunch OutTime -->
                                <div class="d-flex align-items-center col-md-2 pading5px">
                                    <asp:Label ID="lbltLantime0" runat="server" CssClass="lblTxt lblName"  Style="margin-right: 5px;">Lunch OutTime</asp:Label>
                                    <asp:Label ID="lbllanouttime" runat="server" Width="98" ReadOnly="true" CssClass="inputTxt inputName inpPixedWidth"></asp:Label>
                                </div>
                                <div class="d-flex align-items-center col-md-1 pading5px">
                                    <asp:DropDownList ID="ddlLanouttime" AutoPostBack="true" OnSelectedIndexChanged="ddlLanouttime_SelectedIndexChanged" runat="server" CssClass="form-control inputTxt" TabIndex="18"></asp:DropDownList>
                                </div>
                            </div>
                            ...
                            <div class="row d-flex align-items-center flex-wrap gap-2">
                                ...
                                <div class="col-md-3 pading5px asitCol3 d-flex align-items-center">
                                ...
                                <div class="col-md-1 pading5px d-flex align-items-center">
                                    <asp:DropDownList ID="ddlEduQua" AutoPostBack="true" OnSelectedIndexChanged="ddlEduQua_SelectedIndexChanged" runat="server" CssClass="form-control inputTxt" TabIndex="21"></asp:DropDownList>
                                </div>
                                ...
                                <!-- Agreement Dropdown -->
                                <div class="col-md-2 pading5px d-flex align-items-center">
                                ...
                                <div class="row">
                                    <asp:Panel ID="Panel6" runat="server">
                                        <div class="col-md-12">
                                            ...
                                            <asp:Label ID="lblhourlyRate" runat="server" CssClass=" lblTxt lblName">Hourly Rate</asp:Label>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="col-md-5 pading5px">
                                            <asp:Label ID="Label7" runat="server" CssClass="lblTxt lblName">Night Allow.</asp:Label>
                                ...
                                <div class="row">
                                    <asp:Panel ID="pnlNightAllowRate" runat="server">
                                        <div class="col-md-12">
                                            <asp:Label ID="lblnfixedrate" runat="server" Visible="true" CssClass=" lblTxt lblName">Rate</asp:Label>
                                            <asp:TextBox ID="txtnfixedrate" runat="server" Visible="true" TabIndex="32" CssClass="inputTxt inputName inpPixedWidth"></asp:TextBox>

                                            <asp:Label ID="lblncelling1" runat="server" CssClass="smLbl_to">Ceiling(9PM-12:30AM)</asp:Label>
                                            <asp:TextBox ID="txtncelling1" runat="server" TabIndex="33" CssClass="inputTxt inputName inpPixedWidth"></asp:TextBox>

                                            <asp:Label ID="lblncelling2" runat="server" CssClass="smLbl_to">Ceiling(12:30AM-ABOVE)</asp:Label>
                    ...
                    <div class="row d-flex align-items-center gap-2">
                        ...
                        <div class="col-md-5 d-flex align-items-center">
                            ...
                            <asp:TextBox ID="txtgrossal" runat="server" Visible="False" BackColor="Yellow" CssClass="inputTxt inputName" TabIndex="38"></asp:TextBox>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                               <asp:LinkButton ID="lnkbtnFinalSWUpdate" runat="server" Width="100px " CssClass="btn btn-success text-center text-white"
                OnClick="lnkbtnFinalSWUpdate_Click"
                Visible="False" TabIndex="39">Final Update</asp:LinkButton>

               <asp:LinkButton ID="lnkUserGenerate" runat="server" CssClass="btn btn-warning text-center text-white" 
                Visible="false" OnClick="lnkUserGenerate_Click"
